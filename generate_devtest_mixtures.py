...
if __name__ == '__main__':
    ...
    parser.add_argument('-params', help='Parameter file (yaml) for the devtest mixtures '
                        ...
                        required=False, default='mixing_params_devtest_dcase_fixed.yaml', dest='params')
    args = parser.parse_args()

    main(data_path=args.data_path,
         generate_devtrain_recipes=False,
         generate_devtest_recipes=True,
         synthesize_devtrain_mixtures=False,
         synthesize_devtest_mixtures=True,
         devtest_mixing_param_file=args.params)